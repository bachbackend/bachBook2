...
public class ChiTietDonHang {
    ...
    public String toString() {
        return "ChiTietDonHang{" + "maChiTietDonHang=" + maChiTietDonHang + ", donHang=" + donHang + ", sanPham=" + sanPham + ", soLuong=" + soLuong + ", giaGoc=" + giaGoc + ", giamGia=" + giamGia + ", giaBan=" + giaBan + ", thueVAT=" + thueVAT + ", tongTien=" + tongTien + '}';
    }
