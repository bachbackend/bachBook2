<%-- 
    Document   : index
    Created on : May 1, 2024, 12:57:32 AM
    Author     : lebac
--%>
...
<html>
    ...
    <body>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <!--				<div id="carouselExampleIndicators" class="carousel slide mb-4"
                                                            ...
                                                            <div class="carousel-inner">
                                                                    <div class="carousel-item active">
                                                                            <img src="image/xe1.jpg" class="d-block w-100" alt="...">
                                                                    </div>
                                                                    <div class="carousel-item">
                                                                            <img src="image/xe2.jpg" class="d-block w-100" alt="...">
                                                                    </div>
                                                                    <div class="carousel-item">
                                                                            <img src="image/xe3.jpg" class="d-block w-100" alt="...">
                                                                    </div>
                                                            </div>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide mb-4" data-bs-ride="true">
                        ...
                        <div class="carousel-inner" style="height: 500px;"> <!-- Đặt chiều cao cố định -->
                            <div class="carousel-item active">
                                <img src="image/xe1.jpg" class="d-block w-100" alt="Slide 1" style="object-fit: cover; height: 100%;"> <!-- Sử dụng object-fit để đảm bảo ảnh lấp đầy không gian -->
                            </div>
                            <div class="carousel-item">
                                <img src="image/xe2.jpg" class="d-block w-100" alt="Slide 2" style="object-fit: cover; height: 100%;"> <!-- Đặt chiều cao tương tự -->
                            </div>
                            <div class="carousel-item">
                                <img src="image/xe3.jpg" class="d-block w-100" alt="Slide 3" style="object-fit: cover; height: 100%;"> <!-- Đặt chiều cao tương tự -->
                            </div>
                        </div>
        ...
        <footer class="py-3 my-4">
            ...
            <p class="text-center text-muted">© Lê Như Bách</p>
        </footer>
        <!-- End footer -->
